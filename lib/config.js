...
export function resolveConfig(config = {}) {
    ...
    try {
        ...
        throw new VisionToolkitError('config', 'provider.credential is not a valid credential reference. Keep the reference name here (e.g. VISION_API_KEY) and store the API key itself via the credential input below.');
    }
