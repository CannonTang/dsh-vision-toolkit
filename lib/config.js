...
export function resolveConfig(config = {}) {
    ...
    try {
        ...
        throw new VisionToolkitError('config', 'provider.credential is not a valid credential reference. Keep the reference name here (e.g. VISION_API_KEY) and set the API key itself directly in provider.apiKey or via DSH credentials.');
    }
